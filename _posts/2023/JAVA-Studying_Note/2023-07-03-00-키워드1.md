...
2. 배열 생성
	...
	2. 방법2: [new 연산자 이용](https://m1nkyu.github.io/new 연산자-이용/)
3. 배열 길이
	1. `배열변수.length;`
4. String[] args
5. [다차원 배열](https://m1nkyu.github.io/다차원-배열)
	1. `int[][] scores = new int[2][3];`
6. 객체를 참조
	1. String[] 배열은 각 항목에 문자열이 아닌 String 객체 번지 가짐
	2. String[] 배열 항목 간 문자열 비교는 == 대신 `equals()` 사용
7. [배열 복사](https://m1nkyu.github.io/배열-복사/)
	1. for문 사용
...
3. [Calendar 클래스](https://m1nkyu.github.io/Calendar-클래스)
...
4. 구성 멤버
	...
	2. [생성자](https://m1nkyu.github.io/생성자/)
